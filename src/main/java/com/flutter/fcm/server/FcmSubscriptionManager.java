...
public class FcmSubscriptionManager {
  ...
  private static InputStream getServiceAccount() {
    return FcmSender.class.getClassLoader().getResourceAsStream("{{YOUR_CONFIG}}");
  }
  ...
  private static void subscribeFcmRegistrationTokensToTopic() throws Exception {
    List<String> registrationTokens = Arrays.asList("{{YOUR_CONFIG}}"); // TODO: add FCM Registration Tokens to
    // subscribe
